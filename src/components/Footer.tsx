      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4">
              <div className="bg-sport-highlight rounded-full p-1">
                <div className="bg-gray-900 rounded-full p-1">
                  <div className="h-5 w-5 bg-sport-highlight rounded-full"></div>
                </div>
              </div>
            ...
            <p className="text-sm">
              Sua plataforma completa para acompanhar resultados esportivos em tempo real.
            </p>
          </div>
          
          <div>
            <h3 className="text-white font-medium mb-4">Conteúdo</h3>
            <ul className="space-y-2 text-sm">
              <li><Link to="/live" className="hover:text-white transition-colors">Jogos ao vivo</Link></li>
              <li><Link to="/schedule" className="hover:text-white transition-colors">Calendário</Link></li>
              <li><Link to="/leagues" className="hover:text-white transition-colors">Competições</Link></li>
              <li><Link to="/teams" className="hover:text-white transition-colors">Times</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row md:justify-between text-sm">
          <p>&copy; {currentYear} Score Sphere. Todos os direitos reservados.</p>
